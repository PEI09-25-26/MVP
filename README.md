...
export CV2_MODEL_PATH=runs/archive3_final/weights/best.pt
uvicorn cv_service:app --host 0.0.0.0 --port 8001 --reload
```

### Passo 2: Iniciar o Game Engine (Terminal 2)
```bash
cd backend/ComputerVision_1.0
uvicorn game_service:app --host 0.0.0.0 --port 8002 --reload
```

### Passo 3: Iniciar o Middleware (Terminal 3)
```bash
cd middleware
uvicorn main:app --host 0.0.0.0 --port 8000 --reload
```

### Passo 4: Abrir o Android Studio
```bash
android-studio
```